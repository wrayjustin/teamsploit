...
#	Based on the Meterpreter script by: Jerome Athias <jerome.athias [at] free.fr>
#
...
print_status("Killing All Administrative and Defensive processes on the target...")
